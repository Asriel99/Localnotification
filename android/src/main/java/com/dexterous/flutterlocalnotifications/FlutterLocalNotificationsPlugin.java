...
public class FlutterLocalNotificationsPlugin implements MethodCallHandler {
    private  final String SHARED_PREFERENCES_KEY = "notification_plugin_cache";
    private  final String DRAWABLE = "drawable";
    private  final String DEFAULT_ICON = "defaultIcon";
    private  final String SELECT_NOTIFICATION = "SELECT_NOTIFICATION";
    private  final String SCHEDULED_NOTIFICATIONS = "scheduled_notifications";
    private  final String INITIALIZE_METHOD = "initialize";
    private  final String CREATE_NOTIFICATION_CHANNEL_METHOD = "createNotificationChannel";
    private  final String DELETE_NOTIFICATION_CHANNEL_METHOD = "deleteNotificationChannel";
    private  final String PENDING_NOTIFICATION_REQUESTS_METHOD = "pendingNotificationRequests";
    private  final String SHOW_METHOD = "show";
    private  final String CANCEL_METHOD = "cancel";
    private  final String CANCEL_ALL_METHOD = "cancelAll";
    private  final String SCHEDULE_METHOD = "schedule";
    private  final String PERIODICALLY_SHOW_METHOD = "periodicallyShow";
    private  final String SHOW_DAILY_AT_TIME_METHOD = "showDailyAtTime";
    private  final String SHOW_WEEKLY_AT_DAY_AND_TIME_METHOD = "showWeeklyAtDayAndTime";
    private  final String GET_NOTIFICATION_APP_LAUNCH_DETAILS_METHOD = "getNotificationAppLaunchDetails";
    private  final String METHOD_CHANNEL = "dexterous.com/flutter/local_notifications";
    private  final String PAYLOAD = "payload";
    private  final String INVALID_ICON_ERROR_CODE = "INVALID_ICON";
    private  final String INVALID_LARGE_ICON_ERROR_CODE = "INVALID_LARGE_ICON";
    private  final String INVALID_BIG_PICTURE_ERROR_CODE = "INVALID_BIG_PICTURE";
    private  final String INVALID_SOUND_ERROR_CODE = "INVALID_SOUND";
    private  final String INVALID_LED_DETAILS_ERROR_CODE = "INVALID_LED_DETAILS";
    private  final String INVALID_LED_DETAILS_ERROR_MESSAGE = "Must specify both ledOnMs and ledOffMs to configure the blink cycle on older versions of Android before Oreo";
    private  final String NOTIFICATION_LAUNCHED_APP = "notificationLaunchedApp";
    ...
    private  final String INVALID_RAW_RESOURCE_ERROR_MESSAGE = "The resource %s could not be found. Please make sure it has been added as a raw resource to your Android head project.";
     String NOTIFICATION_ID = "notification_id";
     String NOTIFICATION = "notification";
     String NOTIFICATION_DETAILS = "notificationDetails";
    ...
    FlutterLocalNotificationsPlugin(Registrar registrar){
    this.registrar = registrar;
    this.channel = new MethodChannel(registrar.messenger(), METHOD_CHANNEL);
    this.channel.setMethodCallHandler(this);
    this.notificationManager = (NotificationManager) registrar.context().getSystemService(Context.NOTIFICATION_SERVICE);
...
//    }
      ...
      private Notification createNotification(Context context, NotificationDetails notificationDetails) {
            setupNotificationChannel(context, NotificationChannelDetails.fromNotificationDetails(notificationDetails));
//        this.intent.setAction(SELECT_NOTIFICATION);
//        this.intent.putExtra(PAYLOAD, notificationDetails.payload);
//        PendingIntent pendingIntent = PendingIntent.getActivity(context, notificationDetails.id, this.intent, PendingIntent.FLAG_UPDATE_CURRENT);
...
//    private  void setSmallIcon(Context context, NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
...
//    }
    ...
    private  ArrayList<NotificationDetails> loadScheduledNotifications(Context context) {
    ...
    private  void saveScheduledNotifications(Context context, ArrayList<NotificationDetails> scheduledNotifications) {
        Gson gson = buildGson();
     ...
     void removeNotificationFromCache(Integer notificationId, Context context) {
        ArrayList<NotificationDetails> scheduledNotifications = loadScheduledNotifications(context);
...
//    private  void scheduleNotification(Context context, final NotificationDetails notificationDetails, Boolean updateScheduledNotificationsCache) {
//        Gson gson = buildGson();
...
//    private  void repeatNotification(Context context, NotificationDetails notificationDetails, Boolean updateScheduledNotificationsCache) {
//        Gson gson = buildGson();
//        String notificationDetailsJson = gson.toJson(notificationDetails);
//        Intent notificationIntent = new Intent(context, ScheduledNotificationReceiver.class);
//        notificationIntent.putExtra(NOTIFICATION_DETAILS, notificationDetailsJson);
...
//    }
    ...
    private  void saveScheduledNotification(Context context, NotificationDetails notificationDetails) {
        ArrayList<NotificationDetails> scheduledNotifications = loadScheduledNotifications(context);
    ...
    private  Bitmap getBitmapFromSource(Context context, String bitmapPath, BitmapSource bitmapSource) {
        Bitmap bitmap = null;
    ...
    private  IconCompat getIconFromSource(Context context, String iconPath, IconSource iconSource) {
     ...
     */
    private  void setVisibility(NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
    ...
    private  void applyGrouping(NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
    ...
    private  void setVibrationPattern(NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
    ...
    private  void setLights(NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
    ...
    private  void setSound(Context context, NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
    ...
    private  void setCategory(NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
    ...
    private  void setTimeoutAfter(NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
...
//    }
    ...
    private  void setStyle(Context context, NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
    ...
    private  void setProgress(NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
    ...
    private  void setBigPictureStyle(Context context, NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
    ...
    private  void setInboxStyle(NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
    ...
    private  void setMediaStyle(NotificationCompat.Builder builder) {
        androidx.media.app.NotificationCompat.MediaStyle mediaStyle = new androidx.media.app.NotificationCompat.MediaStyle();
        builder.setStyle(mediaStyle);
    }

    private  void setMessagingStyle(Context context, NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
    ...
    private  NotificationCompat.MessagingStyle.Message createMessage(Context context, MessageDetails messageDetails) {
    ...
    private  Person buildPerson(Context context, PersonDetails personDetails) {
    ...
    private  void setBigTextStyle(NotificationDetails notificationDetails, NotificationCompat.Builder builder) {
    ...
    private  void setupNotificationChannel(Context context, NotificationChannelDetails notificationChannelDetails) {
    ...
    private  Uri retrieveSoundResourceUri(Context context, String sound, SoundSource soundSource) {
        Uri uri = null;
...
//    }
    ...
    private void showN(Context applicationContext, NotificationDetails notificationDetails) {
    }
